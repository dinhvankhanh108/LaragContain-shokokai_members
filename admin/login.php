...
// echo EncryptData("LoginID01") . '<br/>';
// echo EncryptData("admin1");
// echo '<pre>';
// print_r($_SESSION);
// echo '<pre>';
?>
...
<head>
	...
	<!-- [CSS] -->
	<link rel="stylesheet" href="assets/css/login/import.css">
...
<body>
	<div id="Wrapper">
			...
			<div class="inner">
				...
				<div class="login">
					...
					<div style="text-align: center;">
						<span style="color:red;"><?= @$_SESSION['admin']['classError']['text'] ?></span>
					</div>
					...
					<form method="POST" action="">
						<dl>
							...
							<dt><button type="submit" class="login_button">ログイン</button><input type="hidden" name="next" value="" /></dt>
							<dd></dd>
						</dl>
					</form>
		...
		<footer>
			<div class="inner">
				<a href="https://www.sorimachi.co.jp/" target="_blank"><img src="assets/images/f_logo.svg" alt="ソリマチ株式会社" width="180px" /></a>
